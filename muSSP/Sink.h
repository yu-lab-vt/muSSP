...
//    vector<bool> used_sink_precursor;
    ...
    void sink_update_all(vector<Node> &V, vector<double> &distance2src, int sink_id, int n);

    void sink_update_all_weight(vector<Node> &V, vector<double> &distance2src, int sink_id, int n);
